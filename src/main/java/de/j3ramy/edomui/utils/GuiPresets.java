...
public class GuiPresets {
    ...
    public static final FontSize CHECKBOX_FONT_SIZE = FontSize.XS;
    ...
    public static final FontSize SCROLLABLE_LIST_FONT_SIZE = FontSize.XS;

    public static final FontSize TOOLTIP_FONT_SIZE = FontSize.S;

    public static final FontSize TABLE_COLUMN_FONT_SIZE = FontSize.XS;
    ...
    public static final int PROGRESS_BAR_BAR = Color.BLUE;
    ...
    public static final int TEXT_FIELD_PLACEHOLDER_TEXT = Color.GRAY;

    public static final int SCROLLBAR_THUMB_COLOR = Color.GRAY;

    public static final int CHECKBOX_TEXT_COLOR = Color.DARK_GRAY;
